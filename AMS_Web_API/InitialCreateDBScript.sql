...
VALUES (1, N'Address 1', N'Address 2', 0, '2020-04-26T09:17:24.7731740-04:00', NULL, CAST(1 AS bit), CAST(1 AS bit), 0, '2020-04-26T09:17:24.7731760-04:00', N'Business Name', N'zz', N'zzzzz');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Address1', N'Address2', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Name', N'State', N'ZipCode') AND [object_id] = OBJECT_ID(N'[Businesses]'))
...
VALUES (1, 0, '2020-04-26T09:17:24.7735430-04:00', N'New Group', CAST(1 AS bit), CAST(1 AS bit), 0, '2020-04-26T09:17:24.7735450-04:00', 0);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Order') AND [object_id] = OBJECT_ID(N'[Groups]'))
...
VALUES (1, 0, '2020-04-26T09:17:24.7590640-04:00', N'Admin', CAST(1 AS bit), CAST(1 AS bit), 0, '2020-04-26T09:17:24.7712840-04:00'),
(2, 0, '2020-04-26T09:17:24.7716580-04:00', N'User', CAST(1 AS bit), CAST(1 AS bit), 0, '2020-04-26T09:17:24.7716670-04:00'),
(3, 0, '2020-04-26T09:17:24.7716750-04:00', N'Viewer', CAST(1 AS bit), CAST(1 AS bit), 0, '2020-04-26T09:17:24.7716750-04:00');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate') AND [object_id] = OBJECT_ID(N'[Roles]'))
...
VALUES (N'20200426131725_InitalCreateDB', N'3.1.2');
