...
VALUES (1, N'Address 1', N'Address 2', 0, '2020-07-15T09:26:56.7999880-04:00', NULL, CAST(1 AS bit), CAST(1 AS bit), 0, '2020-07-15T09:26:56.7999900-04:00', N'Business Name', N'zz', N'zzzzz');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Address1', N'Address2', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'Name', N'State', N'ZipCode') AND [object_id] = OBJECT_ID(N'[Businesses]'))
...
VALUES (1, 0, '2020-07-15T09:26:56.8004530-04:00', N'New Group', CAST(1 AS bit), CAST(1 AS bit), 0, '2020-07-15T09:26:56.8004560-04:00', 0);
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate', N'SortId') AND [object_id] = OBJECT_ID(N'[Groups]'))
...
VALUES (1, 0, '2020-07-15T09:26:56.7848760-04:00', N'Admin', CAST(1 AS bit), CAST(1 AS bit), 0, '2020-07-15T09:26:56.7979890-04:00'),
(2, 0, '2020-07-15T09:26:56.7983270-04:00', N'User', CAST(1 AS bit), CAST(1 AS bit), 0, '2020-07-15T09:26:56.7983310-04:00'),
(3, 0, '2020-07-15T09:26:56.7983370-04:00', N'Viewer', CAST(1 AS bit), CAST(1 AS bit), 0, '2020-07-15T09:26:56.7983370-04:00');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'CreatedBy', N'CreatedDate', N'Description', N'IsActive', N'IsVisible', N'LastModifiedBy', N'LastModifiedDate') AND [object_id] = OBJECT_ID(N'[Roles]'))
...
VALUES (N'20200715132657_InitalCreateDB_07_15', N'3.1.2');
